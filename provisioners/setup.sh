...
# install curl to be able to be able to make a GET request to verify that the web server is running correctly
...
The virtual machine was provisioned successfully!
Next, run:
$ vagrant ssh
to ssh into the virtual machine as the vagrant user.
